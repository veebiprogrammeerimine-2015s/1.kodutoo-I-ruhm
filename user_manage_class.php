...
class user_manage
{
    ...
    function getAllUsers($keyword=""){
        ...
        $search = "%".$keyword2."%";
        $stmt = $this->connection->prepare("SELECT id, aeg, temperatuur, andur FROM temperatuurid WHERE deleted IS NULL AND (aeg LIKE ?)");
        echo $this->connection->error;
        ...
        $stmt = $this->connection->prepare("SELECT id, aeg, temperatuur, andur FROM temperatuurid WHERE deleted IS NULL ");
        echo $this->connection->error;
    ...
    function deleteUsers($user_id){
        ...
        $stmt = $this->connection->prepare("UPDATE temperatuurid SET deleted=NOW() WHERE id=?");
    ...
    function updateUsers($first_name, $last_name, $phone, $id, $badge){
        ...
        $stmt = $this->connection->prepare("UPDATE temperatuurid SET aeg=?, temperatuur=?, andur=? WHERE id=?");
        echo $this->connection->error;
